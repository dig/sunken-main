...
public class ItemBuilder {
    ...
    /**
     * Initialize item chainable via given ItemStack parameter.
     *
    ...
    /**
     * Initialize the item chainable with no defined Material/ItemStack
     *
     * @since 1.0
     */
    public ItemBuilder() {
    ...
    public ItemBuilder skullOwner(final String name) {
        if (make().getType() == Material.SKELETON_SKULL && make().getDurability() == (byte) 3) {
